...
namespace Datos
{
    public class DbContextCoreFactory : IDesignTimeDbContextFactory<DbContextCore>
    {
        ...
        public DbContextCore CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseSqlServer("Server=DESKTOP-5SRJD1M\\SQLEXPRESS;Database=MiniCore;Trusted_Connection=True;MultipleActiveResultSets=trueEncrypt=false;TrustServerCertificate=true");
